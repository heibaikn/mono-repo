<template>
  <svg xml:space="preserve" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 323 323">
    <path fill="#f0ad00" d="m106.716 99.763 54.785 54.782 54.779-54.782z" />
    <path
      fill="#7fd13b"
      d="M96.881 89.93H216.83l-55.18-55.184H41.7zM228.427 101.523l59.705 59.704L228.16 221.2l-59.705-59.704z" />
