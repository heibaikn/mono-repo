<template>
  <svg viewBox="100 100 800 800" xmlns="http://www.w3.org/2000/svg">
    <linearGradient
      ...
      y1="517.16"
      y2="559.16"
      gradientTransform="translate(-54.117 -62.353) scale(1.1129)"
