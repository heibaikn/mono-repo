<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340">
    <g style="fill-rule: evenodd; fill: none">
      <path
        d="M150 0C67.156 0 0 67.156 0 150s67.156 150 150 150 150-67.156 150-150S232.844 0 150 0z"
        style="stroke-width: 40; stroke: #f5f5f5"
        transform="translate(44.788 44.788) scale(.83475)"
      />
      <path
        transform="matrix(.83475 0 0 -.83475 44.788 289.645)"
        ...
        style="fill-rule: nonzero; fill: #f5f5f5"
      />
    </g>
  </svg>
</template>
