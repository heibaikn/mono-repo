  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      ...
      <linearGradient
        ...
        y1="5"
        y2="43"
        gradientTransform="matrix(1.4324 0 0 1.4363 134.03 -5.86)"
        gradientUnits="userSpaceOnUse">
      ...
      <linearGradient
        ...
        y1="5.008"
        y2="59.329"
        gradientTransform="translate(136.41 -3.39)"
        gradientUnits="userSpaceOnUse">
    ...
    <g opacity=".6">
      <path transform="matrix(1.579 0 0 .71429 130.515 24.54)" d="M38 40h5v7h-5z" fill="url(#a)" />
      <path
        transform="matrix(-1.579 0 0 -.71429 130.515 24.54)"
        d="M-10-47h5v7h-5z"
        fill="url(#b)" />
      <path transform="matrix(1.579 0 0 .71429 130.515 24.54)" d="M10 40h28v7H10z" fill="url(#c)" />
    </g>
